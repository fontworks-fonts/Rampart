...
print ("[Rampart] Generating TTF")
__main__.main(("-g","sources/RampartOne.glyphs", "-o","ttf",))
...
for font in Path("master_ttf").glob("*.ttf"):
    ...
    modifiedFont["name"].addMultilingualName({'ja':'ランパート One'}, modifiedFont, nameID = 1, windows=True, mac=False)
